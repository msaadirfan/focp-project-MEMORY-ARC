...
bool hard_level(RenderWindow& window)
{
    ...
    RectangleShape box7(Vector2f(170, 170));
    RectangleShape box8(Vector2f(170, 170));
    ...
    box7.setFillColor(Color::White);
    box8.setFillColor(Color::White);
    level.setFillColor(Color(255, 0, 0, 0));

    // set positions of boxes
    box1.setPosition(351.f, 246.0f);
    box2.setPosition(531.f, 246.0f);
    box3.setPosition(351.f, 426.0f);
    box4.setPosition(531.f, 426.f);
    box5.setPosition(711.f, 246.f);
    box6.setPosition(711.f, 426.f);
    box7.setPosition(891.f, 246.f);
    box8.setPosition(891.f, 426.f);
    ...
    box7.setOrigin(50.f, 50.f);
    box8.setOrigin(50.f, 50.f);
    ...
    while (window.isOpen()) {
        ...
        for (int j = 0; j < highlight_per_round; j++) {
            ...
            {
                piano_sound.play();
                box7.setFillColor(Color::Black);
            }
            else if (cpu[j] == 8)
            {
                piano_sound.play();
                box8.setFillColor(Color::Black);
            }
            ...
            while (window.pollEvent(userEvnt)) {
                ...
                if (userEvnt.type == Event::MouseButtonPressed) {
                    if (userEvnt.mouseButton.button == Mouse::Left) {
                        ...
                        else if (box7.getGlobalBounds().contains(mousepos))
                        {
                            user[counter] = 7;
                            counter++;
                            userentries++;
                        ...
                        else if (box8.getGlobalBounds().contains(mousepos))
                        {
                            user[counter] = 8;
                            counter++;
                            userentries++;
                ...
                {
                    Vector2f mousepos = window.mapPixelToCoords(Mouse::getPosition(window));
                    if (box1.getGlobalBounds().contains(mousepos) || box2.getGlobalBounds().contains(mousepos) || box3.getGlobalBounds().contains(mousepos) || box4.getGlobalBounds().contains(mousepos) || box5.getGlobalBounds().contains(mousepos) || box6.getGlobalBounds().contains(mousepos) || box7.getGlobalBounds().contains(mousepos) || box8.getGlobalBounds().contains(mousepos))
