...
bool beginner_level(RenderWindow& window)
{
    ...
    box1.setPosition(531.f, 246.0f);
    box2.setPosition(711.f, 246.0f);
    box3.setPosition(531.f, 426.0f);
    box4.setPosition(711.f, 426.f);
    ...
    while (window.isOpen()) {
        ...
        for (int j = 0; j < highlight_per_round; j++) {
            ...
            std::this_thread::sleep_for(chrono::milliseconds(millisecond));
        ...
        while ((userentries < highlight_per_round) && window.isOpen()) {
            ...
            while (window.pollEvent(userEvnt)) {
                ...
                {
                    Vector2f mousepos = window.mapPixelToCoords(Mouse::getPosition(window));
                    if (box1.getGlobalBounds().contains(mousepos) || box2.getGlobalBounds().contains(mousepos) || box3.getGlobalBounds().contains(mousepos) || box4.getGlobalBounds().contains(mousepos))
